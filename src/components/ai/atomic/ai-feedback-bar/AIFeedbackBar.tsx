...
function AITooltip({ label, anchorRef, visible }: {
  ...
  return ReactDOM.createPortal(
    <div role="tooltip" style={{
      ...
      ...AI_TYPOGRAPHY['@ai-section-subtitle'], fontFamily: F,
...
function FeedBtn({ path, label, active, bgActive, colorActive, hovColor, bgHov, onClick }: {
  ...
  const resolvedHovColor = hovColor ?? 'var(--ai-ds-text)';
    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          color: active ? colorActive : hov ? resolvedHovColor : 'var(--ai-ds-helper)',
    ...
    <div style={{
      ...
      {received ? (
        <div style={{
          ...
          color: '#15803d', fontFamily: F, ...AI_TYPOGRAPHY['@ai-caption-1'],
