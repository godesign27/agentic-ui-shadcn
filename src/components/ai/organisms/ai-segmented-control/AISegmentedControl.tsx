...
/**
 * AISegmentedControl — the DS Segmented Control, re-imagined in the Guild AI
 * brand, built on the signature "Pill" treatment that used to live inside AITab.
 *
 * It mirrors the standard DS Segmented Control contract one-to-one — mutually
 ...
 *   - inactive         transparent chip, --ai-ds-text label
        ...
        return (
          <button
            ...
            style={{
              ...
              ...AI_TYPOGRAPHY['@ai-body-small'], fontFamily: F, fontSize: d.fs,
