/**
 * DSBreadcrumbs — DS Breadcrumb navigation component
 *
 * GitHub source: upstream AI component source · src/breadcrumbs/
...
export type DSBreadcrumbSize = 'normal' | 'small' | 'x-small';
export type DSBreadcrumbVariant = 'default' | 'inverse';
...
const SIZE: Record<DSBreadcrumbSize, SizeCfg> = {
...
function palette(variant: DSBreadcrumbVariant): Palette {
  if (variant === 'inverse') {
    return {
...
export interface DSBreadcrumbsProps {
  ...
  size?: DSBreadcrumbSize;
  /** 'default' (light bg) | 'inverse' (dark bg). Defaults to 'default'. */
  variant?: DSBreadcrumbVariant;
  /**
   * 'standard' (DS primary teal links) | 'ai' (AI brand-blue links). The AI theme
