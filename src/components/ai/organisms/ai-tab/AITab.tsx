...
/**
 * AITab — the DS Tab, re-imagined in the Guild AI brand.
 *
 * This is the AI-surface sibling of the standard DS Tab (src/tab/). It keeps
 ...
 *   - text / helper      --ai-ds-text / --ai-ds-helper
 ...
 * of the standard DS Segmented Control.
 *
...
// ── AI-tinted icon-font glyph (catalog font, never inline SVG) ──────────────────
...
export function AITab(props: AITabProps) {
  ...
  const panel = (i: number): React.ReactNode => (
    <div style={{ ...AI_TYPOGRAPHY['@ai-body'], color: 'var(--ai-ds-text)' }}>
      <div style={{ ...AI_TYPOGRAPHY['@ai-card-title'], color: 'var(--ai-ds-text)', marginBottom: 6 }}>
        {items[i]?.label}
      </div>
      ...
      <div style={{ display: 'inline-flex', gap: 16, alignItems: 'stretch' }}>
        <div role="tablist" aria-orientation="vertical" style={{ display: 'inline-flex', flexDirection: 'column', width: 200, gap: 4 }}>
          {items.map((item, i) => {
            ...
            const textColor = item.disabled ? 'var(--ai-ds-helper)' : isActive ? brand : 'var(--ai-ds-text)';
            return (
              <button
                ...
                style={{
                  ...
                  ...AI_TYPOGRAPHY['@ai-body-small'], fontFamily: F,
            ...
            return (
              <button
                ...
                style={{
                  ...
                  color: textColor, ...AI_TYPOGRAPHY['@ai-body-small'], fontFamily: F,
    ...
    <div style={{ display: 'inline-block', minWidth: withPanel ? 360 : undefined }}>
      <div role="tablist" aria-orientation="horizontal" style={{
        ...
        {items.map((item, i) => {
          const isActive = i === active;
          const isHover = i === hover && isEnabled(i);
          const textColor = item.disabled ? 'var(--ai-ds-helper)'
            : isActive ? brand : isHover ? 'var(--ai-ds-text)' : 'var(--ai-ds-helper)';
          ...
          return (
            <button
              ...
              style={{
                ...
                ...AI_TYPOGRAPHY['@ai-body'], fontFamily: F, fontWeight: isActive ? 600 : 400, color: textColor,
                boxShadow: focus === i ? focusRing : 'none',
              }}
            >
              <Label item={item} textColor={textColor} iconColor={brand} />
