...
- **Imported AI architecture** — `foundations/`, `atomic/`, `molecules/`, `organisms/`, `patterns/`, `pages/`, `data-viz/`, `tokens/`, `_support/`. Relative imports inside that tree stay intact. Import as `@/components/ai/atomic/ai-avatar/AIAvatar`.
