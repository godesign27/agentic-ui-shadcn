    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ ...AI_TYPOGRAPHY['@zsai-section-subtitle'], color: 'var(--ai-zds-text)' }}>{title}</div>
          {subtitle && (
            <div style={{ ...AI_TYPOGRAPHY['@zsai-agent-name'], color: 'var(--ai-zds-helper)' }}>{subtitle}</div>
          )}
        </div>
      ...
      {open && (
        <div
          id={panelId}
          role="region"
          style={{ padding: '18px 20px', ...AI_TYPOGRAPHY['@zsai-body'], color: 'var(--ai-zds-text)' }}
        >
          {children}
        </div>
      )}
