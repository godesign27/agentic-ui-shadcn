...
// ─────────────────────────────────────────────────────────────────────────────
// AITooltip — the AI-brand counterpart of the DS Tooltip (src/tooltip/).
//
// This is a re-skin, not a re-implementation: the geometry, arrow math, prop
// surface, and section structure are ported verbatim from the DS tooltip
...
// brand-neutral and stay exactly as the DS version has them.
// ─────────────────────────────────────────────────────────────────────────────

// ── Tier 3 tooltip tokens — AITT.* ───────────────────────────────────────────
// Mirrors the DS `TT` token object. Surface + text values are the same neutral
// var(--…, #hex) tokens the DS tooltip uses (brand-neutral by design); the
// teal accent members are intentionally dropped because the footer buttons are
// now the AIButton atom. Shadow values reuse the DS elevation stack verbatim.
const AITT = {
  // Surface
...
// ─────────────────────────────────────────────────────────────────────────────
// AITooltipLivePreview — ported from DSTooltipLivePreview, using the AI blocks.
