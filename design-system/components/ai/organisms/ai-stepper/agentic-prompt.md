...
- **Component id:** `ai-stepper`
- **Category:** organisms
- **Status:** Beta
- **File path:** `src/app/components/ai/organisms/ai-stepper/AIStepper.tsx`
...
- **Category:** organisms
- **Status:** Beta
- **Source path:** `src/app/components/ai/organisms/ai-stepper/AIStepper.tsx`
...
## Code example
```tsx
import { AIStepper, type AIStepDef } from 'ai/organisms/ai-stepper/AIStepper';
...
// Inline Compact (neutral) — pill stepper in the DS neutral tone
