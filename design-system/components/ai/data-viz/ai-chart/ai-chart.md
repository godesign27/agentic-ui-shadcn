...
AI Chart (`ai-chart`) — registered in ZSD AI Design System V1.2 (data-viz).
...
| Path | Role |
|------|------|
| `components/ai/data-viz/ai-chart/ai-chart.md` | This mirror spec (stub) |
| `components/ai/data-viz/ai-chart/ai-chart.agent.json` | Agent manifest |

## Notes

- Registry id: `ai-chart`
- Display name: AI Chart
- Status: **Draft**
