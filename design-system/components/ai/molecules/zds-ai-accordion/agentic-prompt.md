...
- **Component id:** `zds-ai-accordion`
- **Category:** molecules
- **Status:** Beta
- **File path:** `ai/molecules/zds-ai-accordion/AIAccordion.tsx`
...
- **Category:** molecules
- **Status:** Beta
- **Source path:** `ai/molecules/zds-ai-accordion/AIAccordion.tsx`
...
## Code example
```tsx
import { AIAccordion } from 'ai/molecules/zds-ai-accordion/AIAccordion';
