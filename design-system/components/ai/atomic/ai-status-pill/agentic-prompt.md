...
You are implementing the **AI Status Pill** from the Guild AI Design System mirror.
---
...
2. **AI Avatar = three AI_RAMP blue circles + white cross-star.** Fixed fills `#B4BDFF` / `#5A6DFF` / `#1F2A66`, white star. **No orange gradient ring. No "Z" letterform. No emoji. No theme inversion.**
